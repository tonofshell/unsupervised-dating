...
full_data_descriptives[[3]] %>% kable(caption = "Date-time Variables") %>% kable_styling(bootstrap_options = c("striped", "condensed", "responsive"))
full_data_descriptives[[6]] %>% kable(caption = "Time Period Variables") %>% kable_styling(bootstrap_options = c("striped", "condensed", "responsive"))
```
