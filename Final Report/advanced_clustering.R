...
## ----imputing, eval=FALSE, error=TRUE, cache=TRUE, include=FALSE--------------
...
## ----pca-1, eval=FALSE, include=FALSE-----------------------------------------
...
## ----clara, eval=FALSE, include=FALSE-----------------------------------------
...
## ----dbscan, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE----------
...
## ----descr-stats, cache=TRUE, fig.height = 8, fig.width = 11------------------
